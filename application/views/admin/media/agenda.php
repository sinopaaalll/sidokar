            ...
            <tbody>
                ...
                foreach ($agenda as $a) : ?>
                    <tr>
                        ...
                        <td>
                            <center>
                                <button type="button" class="btn btn-warning btn-sm mb-1" data-toggle="modal" data-target="#modalEdit<?= $a->id ?>"><i class="fas fa-edit"></i></button>
                            </center>
                        </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Form Edit Agenda</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="form" action="<?= base_url('admin/media/agenda/edit/' . $a->id); ?>" enctype="multipart/form-data" method="post" autocomplete="off">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <div class="custom-file">
                                    ...
                                    <input type="hidden" name="old_foto" value="<?= $a->gambar ?>">
                                </div>
                            </div>
